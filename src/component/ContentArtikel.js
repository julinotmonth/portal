   ...
   useEffect(() => {
       ...
       fetch(`http://localhost:5000/artikel/${id}`)
           ...
           .then((data) => {
               ...
               setArtikels(data); // Jika hanya satu produk, ambil langsung data[0]
           })
                        ...
                        <Row>
                            <Col xl={8} lg={8} md={12} sm={12}>
                                <div className="wadah_content_column_berita margin_right_politik_left">
                                    <h1 className="judul_berita_h1">{artikels.name_artikel}</h1>
                                    <div className="wadah_tanggal_hari_jam">
                                        ...
                                        <span className="span_calendar_content_politik">{format(new Date(artikels.updatedAt), "EEEE, d MMMM yyyy HH:mm 'WIB'", { locale: localeId })}</span>
                                    </div>
                                    <div className="wadah_img_deskrip">
                                        <div className="wadah_img_berita_politik">
                                            <img src={artikels.url_artikel} className="img_content_berita_politik" />
                                        </div>
                                        <div className="wadah_deskripsi_berita_politik">
                                            <span className="deskripsi_berita_politik">
                                                {artikels.deskrip_img_artikel}
                                            </span>
                                        </div>
                                        <div className="wadah_quotes_berita_politik">
                                            <span className="span_quotes_berita_politik">
                                                {artikels.parag_highlight_artikel}
                                            </span>
                                        </div>
                                        <div className="wadah_deskripsi_berita_all">
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_1_artikel}</span>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_2_artikel}</span>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_3_artikel}</span>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_4_artikel}</span>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_7_artikel}</span>
                                            </div>
                                            <div className="wadah_baca_juga">
                                                <span className="span_baca_juga">Baca juga:</span>
                                                <Link className="link_baca_juga"> {artikels.parag_5_artikel}</Link>
                                            </div>
                                            <div className="wadah_baca_juga margin_bottom_baca_juga">
                                                <span className="span_baca_juga">Baca juga:</span>
                                                <Link className="link_baca_juga"> {artikels.parag_6_artikel}</Link>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_8_artikel}</span>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_9_artikel}</span>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_10_artikel}</span>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_11_artikel}</span>
                                            </div>
                                            <div className="wadah_deskripsi_berita_1">
                                                <span className="span_deskripsi_berita_1">{artikels.parag_12_artikel}</span>
                                            </div>
                                        </div>
                                        <div className="wadah_name_pewarta_editor_copyright">
                                            <div className="wadah_pewarta">
                                                <span className="content_name_pewarta">Pewarta: {artikels.penulis_artikel}</span>
                                            </div>
                                            <div className="wadah_pewarta">
                                                <span className="content_name_pewarta">Editor: {artikels.editor_artikel}</span>
                                            </div>
                                            <div className="wadah_pewarta">
