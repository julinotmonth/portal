...
import hukum_left_img_1 from "../img/hukum_left_img_1.webp"
                            ...
                            <Col xl={8} lg={8} md={12} sm={12}>
                                <div className="wadah_content_left_politik_all margin_right_politik_left">
                                    <div className="wadah_content_editor margin_bottom_editor">
                                        <h4 className="judul_content_editor">Hukum</h4>
                                            ...
                                            <Col xl={5} lg={6} md={6} sm={12}>
                                                <div className="wadah_content_terkini_politik_2 margin_right_politik_2 margin_bottom_politik_2">
                                                    <div className="wadah_img_terkini_politik">
                                                        <Link to="/hukum/berita" className="link_img_terkini_politik">
                                                            <img src={hukum_left_img_1} className="img_terkini_politik" />
                                                        </Link>
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col xl={7} lg={6} md={6} sm={12}>
                                                <div className="wadah_content_deskripsi_politik">
                                                    <div className="wadah_content_deskripsi_politik_2">
                                                        <Link to="/hukum/berita" className="link_content_deskripsi_politik_2">Hukum kemarin, kotak kosong pilkada hingga persiapan pembukaan PON XXI</Link>
                                                    </div>
                                                    <div className="wadah_span_menit_tayang">
                                                        <span>22 menit lalu</span>
                                                    </div>
                                                    <div className="wadah_deskripsi_content_deskripsi_politik_2">
                                                        <p className="deskripsi_content_deskripsi_politik_2">Beragam berita hukum telah diwartakan Kantor Berita Antara, berikut kami rangkum berita terpopuler kemarin yang masih ...</p>
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col xl={5} lg={6} md={6} sm={12}>
